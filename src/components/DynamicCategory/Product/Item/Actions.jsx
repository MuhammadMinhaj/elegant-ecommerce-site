...
function Actions({ isSmall }) {
  ...
  return (
    <Box borderRadius="1rem">
      ...
      <ActionButton isSmall={isSmall} name="View this" icon={<VisibilityOutlinedIcon />} handleClick={() => router.push('/product/demo')} />
      <ActionButton isSmall={isSmall} name="Compare this" icon={<CompareArrowsIcon />} />
      <ActionButton isSmall={isSmall} name="Add to wishlist" icon={<FavoriteBorderOutlinedIcon />} />
    </Box>
  );
}
